...
function Floor_1_Screen() {
  ...
  updateSubscription = interval(1000).subscribe((val) => {
    setSensor_z1((x) => (x = WebsocketService.Area1_sensor.zone_1));
    setSensor_z2((x) => (x = WebsocketService.Area1_sensor.zone_2));
    setSensor_z3((x) => (x = WebsocketService.Area1_sensor.zone_3));
    setSensor_z4((x) => (x = WebsocketService.Area1_sensor.zone_4));
